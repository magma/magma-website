          ...
          <section className="section search-content">
            ...
            <div className="field has-addons-centered">
              <form method="post" id="e2ma_signup" onSubmit="return signupFormObj.checkForm(this)" action="https://app.e2ma.net/app2/audience/signup/1900237/1771360/">
                ...
                <input aria-label="Email Address" placeholder="Email Address" id="id_email" name="email" type="email" required="required" size="is-large" className="search-container-input" />
                <button onClick="document.getElementById('e2ma_signup').submit();" className="button is-primary border-search-submit">
                  <span>SUBMIT</span>
                  <span className="ico">
